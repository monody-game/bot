...
const list = Object.values(response.json.data.roles);
...
export default {
    ...
    async callback(interaction) {
        ...
        const color = role.team.id === 1 ? config.colors.villagers : config.colors.werewolves;
        await interaction.reply({
            embeds: [
                new EmbedBuilder()
                    ...
                    .setFields({ name: "**Camp**", value: role.team.display_name, inline: true }, {
