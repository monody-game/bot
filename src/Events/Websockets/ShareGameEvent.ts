...
import {ActionRowBuilder, ButtonBuilder, Client, TextChannel, ButtonStyle} from "discord.js";
...
export default {
  ...
  async callback(client: Client, payload: EventPayload) {
    ...
    const channel = client.channels.cache.get(config.channels.SHARE_GAME) as TextChannel
